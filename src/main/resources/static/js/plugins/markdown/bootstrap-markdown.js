...
!function ($) {
  ...
  , findSelection: function(chunk) {
    var content = this.getContent(), startChunkPosition = content.indexOf(chunk);

    if (startChunkPosition >= 0 && chunk.length > 0) {
  ...
  , focus: function () {
      ...
      $(document).find('.md-editor').each(function(){
        if ($(this).attr('id') != editor.attr('id')) {
          var attachedMarkdown = $(this).find('textarea').data('markdown');

          if (attachedMarkdown == null) {
      ...
      if (editor.hasClass('active') || this.$element.parent().length == 0) {
        ...
        if (isHideable) {
          ...
          if (editable.el != null) {
            ...
            $(editable.attrKeys).each(function(k) {
  ...
  * ========================== */
  ...
  $.fn.markdown = function (option) {
    return this.each(function () {
      ...
      if (!data) $this.data('markdown', new Markdown(this, options));
    })
  };
    ...
    buttons: [
      [{
        ...
        data: [{
          ...
          name: 'cmdHeading',
          title: 'Heading',
          icon: { glyph: 'glyphicon glyphicon-header', fa: 'fa fa-header', 'fa-3': 'icon-header' },
          callback: function(e){
            // Append/remove ### surround the selection
            var chunk, cursor, selected = e.getSelection(), content = e.getContent(), pointer,
            ...
            } else if (selected.start > 0 && (!!prevChar && prevChar != '\n')) {
              e.replaceSelection('\n\n### '+chunk);
        ...
        data: [{
          ...
          icon: { glyph: 'glyphicon glyphicon-search', fa: 'fa fa-search markdown-preview-icon', 'fa-3': 'icon-search' },
          callback: function(e){
