...
@SequenceGenerator(name = "half_hourly_stats_id_gen", sequenceName = "half_hourly_stats_id_gen")
@Entity
@Table(name = "TRNCOUNT_STATS_HALFHOUR")
public class TransactionCountStatisticalDataHalfHourEntity {

	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "half_hourly_stats_id_gen")
	@Id
	private Long id;
	...
	public TransactionCountStatisticalDataHalfHourEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public TransactionCountStatisticalDataHalfHourEntity(String requestDate,
