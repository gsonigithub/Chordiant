...
@SequenceGenerator(name = "tps_stats_id_gen", sequenceName = "tps_stats_id_gen")
@Entity
@Table(name = "TRNCOUNT_STATS_TPS")
public class TransactionCountStatisticalDataTpsEntity {

	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tps_stats_id_gen")
	@Id
	private Long id;
	...
	public TransactionCountStatisticalDataTpsEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public TransactionCountStatisticalDataTpsEntity(String requestDate,
			...
			float slaPerc, String interval, String requestTime, float tps110,
			Date reqDate) {
		super();
