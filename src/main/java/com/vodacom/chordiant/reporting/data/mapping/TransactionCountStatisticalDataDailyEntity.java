...
@SequenceGenerator(name = "daily_stats_id_gen", sequenceName = "daily_stats_id_gen")
@Entity
@Table(name = "TRNCOUNT_STATS_DAILY")
public class TransactionCountStatisticalDataDailyEntity {

	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "daily_stats_id_gen")
	@Id
	private Long id;
	...
	public TransactionCountStatisticalDataDailyEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public TransactionCountStatisticalDataDailyEntity(String requestDate,
			...
			float slaPerc, String interval, Date reqDate) {
		super();
